    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card free-spin-content">
                <div class="card-header free-spin-header"><img class="d-md-flex" src="{{asset('frontend/Default/img/freespin-header.jpg')}}" /></div>
...
<div class="free-spin-footer">
    <div class="footer__wrap-int col-md-8">
        <div class="footer__payment-icons">
            <img class="footer__payment-icons-img-int lazy-loaded" data-lazy-type="image" alt="payment-methods" data-src="{{asset('frontend/Default/img/payment_logo.png')}}" src="{{asset('frontend/Default/img/payment_logo.png')}}">
        </div>
