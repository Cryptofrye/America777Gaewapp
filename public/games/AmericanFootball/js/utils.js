...
function handHide() {
    var hand = document.getElementById("fingerUpGestureContainer");
...
mainSlotRes.open("POST", "/game/AmericanFootball/server?sessionId="+sessionStorage.getItem('sessionId'), true);
...
gc.style.width=100+"vw";
gc.style.height=100+"vh";
gc.style['margin-left']= 0 + "px";
gc.style['margin-top'] = 0 + "px";
