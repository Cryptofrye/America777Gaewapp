...
<div id="profile-modal" class="profile-modal modal">
    ...
    <div class="profile-modal-modal-footer">
            ...
            <div class="profile-modal-footer-second c0l-md-11">
                <div class="begambleaware"><img src="{{asset('frontend/Page/image/other_logo/begambleaware.png')}}" alt=""/></div>
                <div class="plus"><img src="{{asset('frontend/Page/image/other_logo/18-plus.png')}}" alt=""/></div>
                <div class="thawte"><img src="{{asset('frontend/Page/image/other_logo/thawte.png')}}" alt=""/></div>
                <div class="gt"><img src="{{asset('frontend/Page/image/other_logo/gt.png')}}" alt=""/></div>
                <div class="gbga-icon"><img src="{{asset('frontend/Page/image/other_logo/gbga_icon@2x.png')}}" alt=""/></div>
                <div class="gbga-icon"><img src="{{asset('frontend/Page/image/other_logo/gamanon.png')}}" alt=""/></div>
                <div class="ibas-logo-login"><img src="{{asset('frontend/Page/image/other_logo/ibas-logo-login.png')}}" alt=""/></div>
                <div class="gamcare"><img src="{{asset('frontend/Page/image/other_logo/gamcare.png')}}" alt=""/></div>
                <div class="gamblingcommisions"><img src="{{asset('frontend/Page/image/other_logo/gamblingcommisions.png')}}" alt=""/></div>
            </div>
    </div>
    @endif
</div>
