        ...
        public function UpdateJackpots($bet)
        {
            ...
            for( $jp = 1; $jp <= 1; $jp++ ) 
            {
                if( $this->jpgs[$jp - 1]->balance != '' ) 
                {
                    ...
                    {
                        $_obf_0D34100C342A3F3B3C093E1E0D39270B301140212C2F32[$jp - 1] = $count_balance / 100 * $this->slotJackPercent[$jp - 1] + $this->slotJackpot[$jp - 1];
                    }
                    else
                    {
                    ...
                    if( $this->jpgs[$jp - 1]->pay_sum <= $this->slotJackpot[$jp - 1] && !$isJackPay && $this->jpgs[$jp - 1]->pay_sum > 0 ) 
                    {
                        ...
                        $this->Jackpots['jackPay'] = $_obf_0D34100C342A3F3B3C093E1E0D39270B301140212C2F32[$jp - 1];
