...
Route::namespace('Frontend')->middleware(['siteisclosed'])->group(function () {
    ...
    Route::prefix('payment')->group(function () { 
        Route::match(['get', 'post'], 'gigadat/success', 'ProfileController@gigadatSuccess');
        Route::match(['get', 'post'], 'gigadat/failure', 'ProfileController@gigadatFail');
    ...
    */
    ...
    Route::get('profile/history/bonus', [
        ...
        'uses' => 'ProfileController@bonus_history'
    ]);
    Route::get('profile/history/withdraw', [
        'as' => 'frontend.profile.history.withdraw',
        'uses' => 'ProfileController@withdraw_history'
    ]);
